# Usage: obj2carla input.obj [output.obj]
# This will read from input.obj (obj axis system) then convert it into output.obj (carla axis system)
...
def main():
    ...
    if len(args) > 3 or len(args) < 2:
        print("Usage: obj2carla input.obj [output.obj]")
        print("This will read from input.obj (obj axis system) then convert it into output.obj (carla axis system)")
